  ...
  class dbTools
  {
      ...
      public function doBackup($fname = '', $gzip = true)
      {
          ...
          if (!($sql = $this->fetch())) {
              ...
              $fname = BASEPATH . 'dashboard/backups/';
              ...
              if (Registry::get("Database")->affected())
                  redirect_to("user.php?do=backup&backupok=1");
          }
      }
      ...
      public function doRestore($fname)
      {
          ...
          $filename = BASEPATH . 'dashboard/backups/' . trim($fname);
          $templine = '';
          $lines = file($filename);
      ...
      private function fetch()
      {
          ...
          $dump .= '-- @Deprixa Pro' . self::nl;
          $dump .= '-- @author jaomweb.info.' . self::nl;
          $dump .= '-- @copyright 2018' . self::nl;
          $dump .= '-- ' . self::nl;
          $dump .= '-- --------------------------------------------------------------------------------' . self::nl;
