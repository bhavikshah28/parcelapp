...
// *************************************************************************
  ...
  function isAdmin($userlevel)
  {
	  switch ($userlevel) {
		  ...
		  case 3:
		     $display = '<span style="font-size:20px;color:#48CFAD;" class="ti-face-smile" data-toggle="tooltip" data-placement="top" title="User Level 3"></span>';
			 break;

		  case 2:
		     $display = '<span style="font-size:20px;color:#FFB973;" class="ti-user" data-toggle="tooltip" data-placement="top" title="User Manager"></span>';
			 break;
