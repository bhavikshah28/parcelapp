								...
								<div class="row">
									<div class="col-md-12">
										<div class="payment-title">
											...
											<h4 style='font-size: 20px; -webkit-font-smoothing: antialiased; color: #737373;' align='center'>Create an Account</h4></br>
											<p style='font-size: 16px; -webkit-font-smoothing: antialiased; color: #999;' align='left'>Thousands of happy merchants are using Easyship for better shipping. Let’s make you one of them.</p>
										</div>
									</div>
								</div>
								<div id="fullform">
								<form class="xform" id="admin_form" method="post">
									...
									<div class="row">
										<section class="col md-3">
											<select name="code_phone" >		
												<option>Code Phone</option>
									...
									<div class="row">
										<section class="col md-4">
										  <select type="text" class="form-control"  name="country"  required="required">
										...
										<section class="col md-4">
											<label class="input">
											  <input type="text" name="city" placeholder="From City">
											</label>
										</section>
										<section class="col md-4">
											<label class="input">
									...
									<footer>
										<div class="row">
											<div class="col md-8">
												<button class="btn btn-outline-primary btn-confirmation" name="dosubmit" type="submit">Register Account<span><i class="icon-ok"></i></span></button>
											</div>
										</div>
									</footer>
