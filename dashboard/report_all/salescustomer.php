<?php
	...
	$usuario = 'SELECT * FROM add_courier, users WHERE add_courier.username=users.username AND add_courier.act_status=1 AND  add_courier.created  BETWEEN "'.$from.'" AND "'.$until.'" ';	
