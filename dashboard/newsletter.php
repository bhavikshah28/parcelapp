						...
						<form class="xform" id="admin_form" method="post">
						  ...
						  <header><?php echo $lang['send-news1'] ?><span><?php echo $lang['send-news2'] ?></span></header>
							...
							<div class="row">
								<section class="col col-6">
									<label class="input"> <i class="icon-append icon-asterisk"></i>
										<input name="subject" type="text" value="<?php echo $row->subject;?>" placeholder="<?php echo $lang['send-news7'] ?>">
									</label>
							...
							<footer>
								...
								<a href="user.php?do=main" class="button button-secondary"><?php echo $lang['send-news10'] ?></a> 				
							</footer>
						</form>
					</div>
				</div>
