							...
							<div class="card">
								...
								<h4 class="card-title"><?php echo $lang['edit-courier2'] ?></h4>
									<div class="row">
										<div class="col-sm-12 col-md-6">
											<div class="form-group">
												<label for="inputname" class="control-label col-form-label"><?php echo $lang['edit-courier3'] ?></label>
												<input type="text" class="form-control" name="s_name" value="<?php echo $row->s_name;?>" placeholder="<?php echo $lang['edit-courier4'] ?>">
											</div>
										</div>
									...
									<div class="row">									
										<div class="col-sm-12 col-md-6" style="display:none">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="level" value="<?php echo $row->level;?>" placeholder="Staff Role" disabled>
											</div>
										</div>										
										<div class="col-sm-12 col-md-6">
											<label for="inputname" class="control-label col-form-label"><?php echo $lang['edit-courier8'] ?></label>
											<div class="input-group mb-3">
												<input class="form-control"  name="origin_off" value="<?php echo $row->origin_off;?>" readonly>
											</div>
										</div>
										<div class="col-sm-12 col-md-6">
											<label for="inputcontact" class="control-label col-form-label"><?php echo $lang['edit-courier9'] ?></i></label>
											<div class="input-group">
												...
												<input type="text" data-toggle="tooltip" data-placement="bottom" title="<?php echo $lang['edit-courier10'] ?>" class="form-control pickadate" name="collection_courier" placeholder="<?php echo $lang['edit-courier11'] ?>" value="<?php echo $row->collection_courier;?>" />
											</div>
										</div>
									</div>
									<div class="row">
												...
												<div class="col-md-12">
													<div class="row">
														<div class="col-md-offset-3 col-md-9">
															...
															<a href="index.php" class="btn btn-dark"><i class="icon-action-undo"></i><?php echo $lang['edit-courier19'] ?></a> 
														</div>
													</div>
												</div>
							...
							<div class="card">
								...
								<h4 class="card-title"><?php echo $lang['edit-courier20'] ?></h4>
									...
									<div class="card-body bg-light">
										...
										<div class="row">
											<div class="col-sm-12 col-md-6">
												<label for="inputlname" class="control-label col-form-label"><?php echo $lang['edit-courier30'] ?> <i class="ti-package" style="color:#36bea6"></i> <?php echo $lang['edit-courier31'] ?> <b><i style="color:#FF0000" class="ti-help-alt" data-toggle="tooltip" data-placement="top" title="<?php echo $lang['edit-courier32'] ?> / <?php echo $core->meter;?> = kg"></i></b></label>
												<div class="input-group">
													<!-- input box for Length -->
													<input type="number" class="form-control" data-toggle="tooltip" data-placement="bottom" title="<?php echo $lang['edit-courier33'] ?>"  onblur="if(this.value == ''){this.value='0'}"  onKeyUp="suma();" id="l1" name="length" value="<?php echo $row->length;?>">
													<div class="cross strong text__color-gray-darker text__size-smaller">&nbsp; x &nbsp;</div>
													<!-- input box for width -->
													<input type="number" class="form-control" data-toggle="tooltip" data-placement="bottom" title="<?php echo $lang['edit-courier34'] ?>"  onblur="if(this.value == ''){this.value='0'}"  onKeyUp="suma();" id="w2" name="width" value="<?php echo $row->width;?>">
													<div class="cross strong text__color-gray-darker text__size-smaller">&nbsp; x &nbsp;</div>
													<!-- input box for height -->
													<input type="number" class="form-control" data-toggle="tooltip" data-placement="bottom" title="<?php echo $lang['edit-courier35'] ?>"  onblur="if(this.value == ''){this.value='0'}" onKeyUp="suma();" id="h3" name="height" value="<?php echo $row->height;?>">
