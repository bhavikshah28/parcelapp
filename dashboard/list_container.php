						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center">
									...
									<a id="item_<?php echo $row->id;?>"   class="delete"  data-rel="<?php echo $row->username;?>"><button type="button" class="btn btn-sm btn-icon btn-pure btn-outline" data-toggle="tooltip" data-original-title="<?php echo $lang['conlist-title12'] ?>"><i class="ti-close" aria-hidden="true"></i></button></a>
								</td>
							</tr>
							<?php endforeach;?>
							<?php unset($row);?>
