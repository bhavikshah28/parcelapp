								...
								<form class="xform" id="admin_form" method="post">
									...
									<div class="row"> 									
										<div class="col-sm-12 col-md-6">
											...
											<div class="input-group mb-3">
												<select type="text" class="form-control"  name="t_dest" required="required">
									...
									<div class="row"> 									
										<div class="col-sm-12 col-md-6">
											...
											<div class="input-group mb-3">
												...
												<input type="text" class="form-control pickadate" name="t_date" placeholder="mm/dd/yyyy">
											</div>
										</div>
									...
									<div class="row">
										...
										<div class="col-sm-12 col-md-6">
											...
											<div class="input-group mb-3">
												<select class="custom-select" name="status_courier">
