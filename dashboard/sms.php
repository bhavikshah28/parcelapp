				...
				<div class="card">
					<div class="card-body">
						...
						<div class="table-responsive">
							<table id="demo-foo-addrow2" class="table table-hover toggle-circle" data-page-size="5">
								<thead>
									<tr>
								...
								<tbody>
									...
									<tr>
										...
										<td class="text-center">
											<a href="tools.php?do=smstwilio&amp;action=edit&amp;id=<?php echo $row->id;?>"><button type="button" class="btn btn-sm btn-icon btn-pure btn-outline" data-toggle="tooltip" data-original-title="<?php echo $lang['tools-twilio8'] ?>"><i class="ti-pencil" aria-hidden="true"></i></button></a> 											
										</td>
									</tr>
									<?php endforeach;?>
								</tbody>
							...
							<table id="demo-foo-addrow2" class="table table-hover toggle-circle" data-page-size="5">
								...
								<tbody>
									...
									<tr>
										...
										<td class="text-center">
											<a href="tools.php?do=smsnexmo&amp;action=edit&amp;id=<?php echo $row->id;?>"><button type="button" class="btn btn-sm btn-icon btn-pure btn-outline" data-toggle="tooltip" data-original-title="<?php echo $lang['tools-nexmo8'] ?>"><i class="ti-pencil" aria-hidden="true"></i></button></a> 											
										</td>
									</tr>
									<?php endforeach;?>
								</tbody>
