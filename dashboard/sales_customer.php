		...
		<div class="card">
			<div class="card-body">
				...
				<ul class="nav nav-tabs customtab" role="tablist">
					<li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#shipping" role="tab"><span class="hidden-sm-up"><i class="mdi mdi-package-variant-closed"></i></span> <span class="hidden-xs-down">SHIPPING</span></a> </li>						
				</ul>
				<!-- Tab panes -->
