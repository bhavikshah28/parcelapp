		...
		<div class="card">
			<div class="card-body">
				<div class="row">
					<div class="col-md-6">
						<div class="example">
							<h4 class="card-title m-t-30">Shipments Delivered</h4>
							<form id="dForm" method="post" style="padding:0;">
								<div class="input-daterange input-group" id="date-range">
									...
									&nbsp;&nbsp;
									<div class="input-group-append">
										<a target="_blank" href="javascript:shipmentdeliveredPDF();"><img src="assets/images/pdf.png" alt="x" border="0" height="43" width="38" /></a>
									</div>
								</div>
							</form>	
						</div>
...
<script src="dist/js/print_shipmentdelivered.js"></script>
