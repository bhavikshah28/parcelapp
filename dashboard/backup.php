				...
				<div class="card">
					<div class="card-body">
						<div class="d-flex no-block align-items-center m-b-30">
							...
							<div class="ml-auto">
								<div class="btn-group">
									<a href="user.php?do=backup&amp;create=1"><button type="button" class="btn btn-dark" >
							...
							if (is_dir($dir)):
								...
								while (false !== ($file = $getDir->read())):
									if ($file != "." && $file != ".." && $file != "user.php"):
										  ...
										  echo '<div class="db-backup' . $latest . '" id="item_' . $file . '"><i class="icon-hdd pull-left icon-3x icon-white"></i>';
