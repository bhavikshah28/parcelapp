								...
								<div class="row">									
									...
									<div class="col-sm-12 col-md-3">
										...
										<div class="input-group">
											...
											<input type="text" class="form-control pickadate" name="expiration_date" placeholder="<?php echo $lang['edit-container7'] ?>" />
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="table-responsive">
										<table id="bill" class="table" >
											...
											<?php 
												...
												$table = $db->query("SELECT * FROM detail_container WHERE idcon='".Filter::$id."'");
