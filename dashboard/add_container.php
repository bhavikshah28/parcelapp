							...
							<div class="card-body">
								...
								<div class="row">									
									...
									<div class="col-sm-12 col-md-3">
										...
										<div class="input-group">
											...
											<input type="text" data-toggle="tooltip" data-placement="bottom" title="<?php echo $lang['conlist-title34'] ?>" class="form-control pickadate" name="expiration_date" placeholder="Default Pickadate" />
										</div>
									</div>
								</div>
								<div class="row">
								...
								<div class="row"> 									
									...
									<div class="col-sm-12 col-md-3">
										...
										<div class="input-group mb-3">
											<select class="custom-select col-12" name="incoterms">
									...
									<div class="col-sm-12 col-md-3">
											...
											<select class="custom-select col-12" name="r_curren">
