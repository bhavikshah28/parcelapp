  ...
  $('#notice-bar').hide();
        ...
        <div class="body-bg-full quote__wrapper">
          ...
          <div class="col-md-3 p-0">
            <h5 class="m-0 mr-r-5"><?php echo $lang['single_parcel'] ?></h5>
          </div>
...
<li class="list-inline-item active"><a class="text-info"><span class="step">1</span></a> </li>
<li class="list-inline-item"><a class="text-info"><span class="step">2</span></a> </li>
...
<li class="list-inline-item "><a class="text-info"><span class="step">4</span></a> </li>
			...
			<!-- ============================================================== -->
				 ...
				 <?php (Filter::$do && file_exists(Filter::$do.".php")) ? include(Filter::$do.".php") : include("singleparcel_child.php");?>
