									...
									<div class="row">																		
										...
										<div class="col-sm-12 col-md-6">
											...
											<div class="input-group">
												...
												<input type="text" data-toggle="tooltip" data-placement="bottom" title="<?php echo $lang['edit-courieronline9'] ?>" class="form-control pickadate" name="collection_courier" placeholder="<?php echo $lang['edit-courieronline10'] ?>" value="<?php echo $row->collection_courier;?>" />
											</div>
										</div>
									</div>
									<div class="row">
